...
class NameViewModel @Inject constructor(
    ...
    fun setName(name: String) {
        wizardCache.userName.name = name
    }

    fun setSurname(surname: String) {
        wizardCache.userName.surname = surname
    }

    fun setBirthday(birthday: String) {
        wizardCache.userName.birthday = birthday
    }
    ...
    private fun checkAge(): Boolean {
        ...
        try {
            val birthDate = sdf.parse(wizardCache.userName.birthday)
